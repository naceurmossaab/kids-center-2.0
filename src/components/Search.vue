<template>
	<div class="select">
		...
		<select name="category" v-model="category" @change="filterCategorie">
		...
		<select name="city" v-model="city" @change="filterCity">
	...
	export default {
		...
		methods: {
			...
			filterCity() {
				...
				this.$emit("filter-city", this.city);
			},
		},
		emits: ["filter-category", "filter-city"],
	};
</script>
<style scoped>
	.select {
